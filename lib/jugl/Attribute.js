...
/**
 * Class: _jugl.Attribute
 * Instances of this class contain a DOM element and methods to process
 * jugl statements.  Create a new instance with the {_jugl.Attribute}
 * constructor.
 */

/**
 * Constructor: _jugl.Attribute
 *
 * Parameters:
 * element - {_jugl.Element}
 * node - {AttributeNode}
 * type - {String} The localName of the attribute
 *
 * Return:
 * {_jugl.Attribute} A new jugl attribute
 */
_jugl.Attribute = function(element, node, type) {
...
_jugl.object.extend(_jugl.Attribute.prototype, {
   
    /**
     * Property: element
     * {<_jugl.Element>} The owner element of this attribute.
     */
    element: null,
     ...
     * <_jugl.Attribute.processAttribute>.
     *
     * Return:
     ...
     * These methods are called by <_jugl.Attribute.process>
     */
    processAttribute: {
        ...
        "content": function() {
            ...
            if(pair[0] === 'structure') {
                ...
                var child = new _jugl.Element(this.template, text);
        ...
        "replace": function() {
            ...
            if(pair[0] === 'structure') {
                ...
                try {
                    ...
                    msg = "Can't transform string into valid HTML : " + str;
                    throw err;
                }
                if(this.element.node.xml && this.template.xmldom) {
                ...
                var replacement = new _jugl.Element(this.template, text);
