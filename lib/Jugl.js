/**
 * Topic: Jugl Overview
 * Jugl is a JavaScript implementation of the Template Attribute Language.
 */
(function() {
    ...
    Jugl = {
        ...
        /**
         * Property: xmlns
         * {String} Only HTML docs are currently supported, this property is
         * reserved for XML doc support.
         */
        xmlns: null,
        
        /**
         * Property: scriptName
         * *Private.* {String} The relative path to this script
         */
        scriptName: (!singleFile) ? "lib/Jugl.js" : "Jugl.js",
        
        /**
         * Method: getScriptLocation
         * *Private.* Get the path for all library scripts
         * 
         * Return:
