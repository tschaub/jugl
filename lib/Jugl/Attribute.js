...
Jugl.Attribute = new Jugl.Class({
     ...
     * *Private.* Split space-delimited attribute values.
     * 
     * Parameters: 
     ...
     * *Private.* Split semicolon-delimited attributes into an array of
     * expressions
     *
     * Return:
    ...
    /**
     * Method: removeSelf
     * *Private.* Remove this attribute from its node.
     */
    removeSelf: function() {
    ...
    /**
     * Method: process
     * Process this attribute.  This method is called by the parser to process
    ...
    /**
     * Method: evalInScope
     * *Private.* Evaluate a Jugl expression given the scope of its node.
     * 
     * Return:
    ...
    /**
     * Namespace: Jugl.Attribute.processAttribute
     * *Private.* Contains methods to process attributes based on type.
    ...
    processAttribute: {
        ...
        /**
         * Method: define
         * *Private.* Add a variable to the node's scope.  This variable can be used
        ...
        /**
         * Method: condition
         * *Private.* Test the expression given in the attribute.  Continue processing
        ...
        /**
         * Method: repeat
         * *Private.* Replicate a subtree of your document.  The expression
        ...
        /**
         * Method: content
         * *Private.* Rather than replacing an entire node, you can insert text
        ...
        /**
         * Method: replace
         * *Private.* Replace the entire node with the result of the expression.
         * 
         * Return:
         * {Boolean} The attribute value was successfully evaluated.
         */
        ...
        /**
         * Method: attributes
         * *Private.* Add attributes to this node.
         *
         * Return:
         * {Boolean} The attribute value was successfully evaluated.
         */
        ...
        /**
         * Method: omit-tag
         * *Private.* Remove the tag and leave contents in place.
